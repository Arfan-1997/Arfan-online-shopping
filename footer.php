						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Mangalore ,Beeri</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+91-7090128600</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>arfansma7@gmail.com</a></li>
								</ul>
							</div>
						</div>
